...
SECRET_KEY = 'django-insecure-w^w@01b)*p)wvomx41$-_x$$#-vouoo8wdkxy$*k0s!ka(j*b&'
...
if POSTGRES_ENV_VARS:
    # PostgreSQL configuration when environment variables are available
    DATABASES = {
        'default': {
